      ...
      <section className="newsSection containar">
        ...
        <div className="parentNews">
          <div className="newsChildOne">
            <img src="/Photo/news1.webp" alt="img one" className="img" />
            <div className="date">
          ...
          <div className="newsChildOne">
            <img src="/Photo/news2.webp" alt="img two" className="img" />
            <div className="date">
              <i className="fa-solid fa-calendar-days"> </i>
              <h6>24 May 21</h6>
            </div>
          ...
          <div className="newsChildOne">
            <img src="/Photo/news3.webp" alt="img There" className="img" />
            <div className="date">
              <i className="fa-solid fa-calendar-days"> </i>
              <h6>24 May 21</h6>
            </div>
